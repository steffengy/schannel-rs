...
mod test {
    ...
    fn fingerprint() {
        ...
        assert_eq!(
            hash,
            vec![
                0x6C, 0x0F, 0xB7, 0x69, 0x2B, 0x69, 0x16, 0x41, 0x0F, 0xE7, 0x8F, 0xB0, 0x2B, 0xF4,
                0xF5, 0x02, 0x04, 0x5C, 0x88, 0xEF
            ]
        );
        ...
        assert_eq!(
            hash,
            vec![
                0x94, 0xF9, 0x5A, 0xC1, 0x94, 0x9B, 0x5D, 0x31, 0x75, 0x0D, 0x18, 0x25, 0x8B, 0xDD,
                0x01, 0x39, 0x0F, 0x4E, 0xAF, 0x37, 0x6F, 0x17, 0x73, 0x3C, 0x81, 0xEB, 0x28, 0xFF,
                0x90, 0xD4, 0x01, 0x73
            ]
        );
